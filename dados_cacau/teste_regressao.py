...
try:
    df_wide = pd.read_excel("C:\\pedro_ibmec\\quarto_semestre\\inferencia_estatistica\\ap2\\programacao\\api_itc\\dados_cacau\\regressao_vcrs.xlsx", sheet_name="base_regressao")
...
df_summary_final.to_excel("regression_summary_matrix_table.xlsx", index=False)